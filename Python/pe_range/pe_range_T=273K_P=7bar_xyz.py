...
fig_path = f'E:/Graduation Thesis/Figures/pe_range_T={T}K_phi={phi}_P={p}bar.svg'
...
R2 = plt.scatter(R2_x, R2_y, marker='.', color='gray', s=2, label=r"$R_2$")
R3 = plt.scatter(R3_x, R3_y, marker='.', color='red', s=20, label=r"$R_3$")
R1 = plt.scatter(R1_x, R1_y, marker='.', color='blue', s=20, label=r"$R_1$")
