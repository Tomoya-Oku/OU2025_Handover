...
fig_path = f'E:/Graduation Thesis/Figures/temperature_T=273K_revised.svg'
...
for f in fugacity_coeff:
    for p in press:
        path = f"E:/LAMMPS/GCMC_revised/T={T}K/phi={f}/EPM2F_T={T}K_P={p}bar_revised/data/temperature.dat"
