...
def calc_uptake(phi):
    ...
    for p in press:
        if p == 0:
            ...
            path = f"E:\\LAMMPS\\GCMC\\EPM2F\\T=353K\\phi={phi}\\EPM2F_T=353K_P={p}bar\\data\\Ngas.dat"
...
plt.savefig('E:\Graduation Thesis\\Figures\\adsorption_isotherm_EPM2F_T=353K.svg', dpi=600, bbox_inches='tight')
