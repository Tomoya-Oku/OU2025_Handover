...
for m in mu:
    for p in press:
        path = f"E:\\LAMMPS\\GCMC\\p={p}bar_f=0.75_mu={m}\\data\\acceptance.dat"
...
for i, ax in enumerate(axes.flat):
    ...
    ax.set_title(rf'$P={p}\,\mathrm{{bar}},\ \mu={m}$', fontsize=10)  # 各サブプロットにタイトルを追加
...
fig.supylabel('Acceptance ratio', fontsize=16)
...
plt.savefig('E:\Presentation\\241224_midterm\\fig\\acceptance_mu.jpeg', dpi=600, bbox_inches='tight')
