...
mof_path = f"E:\\LAMMPS\\MD_after_GCMC\\Test\\data\\energy_mof.dat"
gas_path = f"E:\\LAMMPS\\MD_after_GCMC\\Test\\data\\energy_gas.dat"
...
ax.plot(time, ke_gas, label='KE (GAS)', color="red")
ax.plot(time, pe_gas, label="PE (GAS)", color="blue")
ax.plot(time, te_gas, label="TE (GAS)", color="black")
