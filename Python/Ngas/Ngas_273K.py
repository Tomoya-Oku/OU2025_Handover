...
fig_path = f'E:/Graduation Thesis/Figures/Ngas_T=273K.svg'
...
for f in fugacity_coeff:
    for p in press:
        path = f"E:/LAMMPS/GCMC/EPM2F/T={T}K/phi={f}/EPM2F_T={T}K_P={p}bar/data/Ngas.dat"
...
fig.supylabel(r'Number of $\mathrm{CO_2}$ molecules', fontsize=15)
