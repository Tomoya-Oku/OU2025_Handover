...
sb.histplot(data=Cu_pe, bins="auto", stat="density", color="orange", alpha=1, element="poly", lw=0, ax=ax, label="Cu")
sb.histplot(data=O1_pe, bins="auto", stat="density", color="red", alpha=1, element="poly", lw=0, ax=ax, label="O(1)")
sb.histplot(data=O2_pe, bins="auto", stat="density", color="magenta", alpha=1, element="poly", lw=0, ax=ax, label="O(2)")
sb.histplot(data=C1_pe, bins="auto", stat="density", color="cyan", alpha=0.75, element="poly", lw=0, ax=ax, label="C(1)")
sb.histplot(data=C2_pe, bins="auto", stat="density", color="lime", alpha=1, element="poly", lw=0, ax=ax, label="C(2)")
sb.histplot(data=C3_pe, bins="auto", stat="density", color="gold", alpha=1, element="poly", lw=0, ax=ax, label="C(3)")
sb.histplot(data=H_pe, bins="auto", stat="density", color="black", alpha=1, element="poly", lw=0, ax=ax, label="H")
