...
for i, ax in enumerate(axes.flat):
    ...
    sb.histplot(data=CO2_pe_permols[i], bins=bins, stat="density", alpha=1.0, color="orange", element="poly", lw=0, ax=ax)
    sb.histplot(data=C_pe_permols[i], bins=bins, stat="density", alpha=0.5, color="gray", element="poly", lw=0, ax=ax)
    sb.histplot(data=O_pe_permols[i], bins=bins, stat="density", alpha=0.5, color="red", element="poly", lw=0, ax=ax)
