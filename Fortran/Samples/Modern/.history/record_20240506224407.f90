subroutine record_posvel
    ...
    integer :: i
    do i = 1, nkoss
        write(3, '(I6, 3D15.7)') i, pos(i,1), pos(i,2), pos(i,3)
        write(4, '(I6, 3D15.7)') i, vel(i,1), vel(i,2), vel(i,3)
    end do
...
subroutine record_finposvel
    ...
    do i = 1, nkoss
        write(9, '(I6, 6D15.7)') i, pos(i,1), pos(i,2), pos(i,3), vel(i,1), vel(i,2), vel(i,3)
    end do
