...
subroutine calc_RK4
    ...
    do i = 1, nkoss
        ...
        k(4,1,1) = calc_ac(posx(i) + k(2,2,1)*0.5, velx(i) + k(2,1,1)*0.5) * dt ! k_4u
        k(4,1,2) = calc_ac(posy(i) + k(2,2,2)*0.5, vely(i) + k(2,1,2)*0.5) * dt ! k_4v
        k(4,1,3) = calc_ac(posz(i) + k(2,2,3)*0.5, velz(i) + k(2,1,3)*0.5) * dt ! k_4w
        k(4,2,1) = (velx(i) + k(2,1,1)*0.5) * dt ! k_4x
        k(4,2,2) = (vely(i) + k(2,1,2)*0.5) * dt ! k_4y
        k(4,2,3) = (velz(i) + k(2,1,3)*0.5) * dt ! k_4z
