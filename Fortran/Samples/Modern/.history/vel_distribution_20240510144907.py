...
def main():
    ...
    start = nkoss*(boundary_step/100)-1

    #datデータの読み込み
    v_x = input_dat[input_dat.keys()].iloc[nkoss*(boundary_step/100)-1:,1].tolist()
    v_y = input_dat[input_dat.keys()].iloc[nkoss*(boundary_step/100)-1:,2].tolist()
    v_z = input_dat[input_dat.keys()].iloc[nkoss*(boundary_step/100)-1:,3].tolist()
