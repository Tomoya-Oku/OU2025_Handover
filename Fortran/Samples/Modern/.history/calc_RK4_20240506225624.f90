...
subroutine calc_RK4
    ...
    double precision, dimension(nkoss, 4) :: k_x
    double precision, dimension(nkoss, 4) :: k_y
    double precision, dimension(nkoss, 4) :: k_z
    double precision, dimension(nkoss, 4) :: k_u
    double precision, dimension(nkoss, 4) :: k_v
    double precision, dimension(nkoss, 4) :: k_w
