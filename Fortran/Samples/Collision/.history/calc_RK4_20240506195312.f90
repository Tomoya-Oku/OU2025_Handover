subroutine calc_ac(pos, vel, acc)
...
subroutine calc_RK4
    ...
    double precision, dimension(4,2,3) :: k ! k = k(RK4_num(1 to 4), (vel:1 pos:2), xyz)
    double precision accx(nkoss) ! acceleration of x
    double precision accy(nkoss) ! acceleration of x
    double precision accz(nkoss) ! acceleration of x
