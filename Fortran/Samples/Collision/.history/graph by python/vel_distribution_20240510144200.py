...
def main():
    ...
    #datデータの読み込み
    v_x = input_dat[input_dat.keys()].iloc[nkoss*200-1:,1].tolist()
    v_y = input_dat[input_dat.keys()].iloc[204799:,2].tolist()
    v_z = input_dat[input_dat.keys()].iloc[204799:,3].tolist()
