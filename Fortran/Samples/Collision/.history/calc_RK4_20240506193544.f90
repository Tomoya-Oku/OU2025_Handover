...
subroutine calc_RK4
    ...
    do i = 1, nkoss
        ...
        posx(i) = posx(i) + (1/6) * (k(1,1,1) + 2*k(2,1,1) + 2*k(3,1,1) + k(4,1,1)) ! renew x
        posy(i) = posy(i) + (1/6) * (k(1,1,2) + 2*k(2,1,2) + 2*k(3,1,2) + k(4,1,2)) ! renew y
        posz(i) = posz(i) + (1/6) * (k(1,1,3) + 2*k(2,1,3) + 2*k(3,1,3) + k(4,1,3)) ! renew z
